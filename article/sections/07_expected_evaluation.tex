...
Current evidence boundary. The artifact package supports a deterministic prototype evaluation over synthetic curated scenarios with automated watcher IA validation. It does not claim completed independent human expert adjudication, production-grade deployment validation, or official CVSS environmental formula equivalence.
